...
const Experience = () => {
  ...
  return (
    ...
    <h1 className={classes.Education} style={{fontSize:"2.3rem"}}>Bachelor's degree, Computer Science</h1>

    <h1 className={classes.Education} style={{fontSize:"1.5rem",color:"#01bf71"}}>University of Engineering & Technology Peshawar</h1>
...
<h1 className={classes.experience} style={{fontSize:"2.3rem"}}>siParadigm Diagnostic Informatics</h1>
    ...
    <p className={classes.experience} style={{fontSize:"1.2rem",color:"#01bf71"}}>KT - Knowledge Transfer/Transition and Handover. Official KT phase through documents. From Jul-2022 to Oct-2022 Online.</p>
...
<h1 className={classes.experience} style={{fontSize:"2.3rem"}}>siParadigm Diagnostic Informatics</h1>
    ...
    <h1 className={classes.experience} style={{fontSize:"1.5rem",color:"#01bf71"}}>DevOps | Support Engineer</h1>

    <h1 className={classes.experience} style={{fontSize:"1.3rem",color:"#fff"}}>Jul 2020 - Oct 2021</h1>

    <p className={classes.experience} style={{fontSize:"1.2rem",color:"#01bf71"}}>Worked on Healthcare Software as a<span style={{color:"#fff"}}> Support Engineer/DevOps </span>.</p>
    <li className={classes.experience} style={{fontSize:"1.2rem",color:"#01bf71"}}>Effective documentation of issues and bugs.</li>
    <li className={classes.experience} style={{fontSize:"1.2rem",color:"#01bf71"}}>Hands-on practice with Jira/Agile, AWS, Ansible, Chef, Docker, Jenkins CI/CD, and Kubernetes.</li>
    <li className={classes.experience} style={{fontSize:"1.2rem",color:"#01bf71"}}>Identified and fixed Production and Testing environment issues.</li>
    <li className={classes.experience} style={{fontSize:"1.2rem",color:"#01bf71"}}>Data fetching from different databases on client/customer requests.</li>
    <li className={classes.experience} style={{fontSize:"1.2rem",color:"#01bf71"}}>Server monitoring and deployment using MobaXterm (Linux Command) and Linux fundamental.</li>
    <li className={classes.experience} style={{fontSize:"1.2rem",color:"#01bf71"}}>Responding in a timely manner to service issues and requests while working on IT Support Position.</li>
    <a className={classes.experience} style={{fontSize:"1.2rem",color:"#fff",}} href="https://tiger.siparadigm.com/tiger/" >Tiger</a>
...
<h1 className={classes.experience} style={{fontSize:"2.3rem"}}>Satsuma Droid Pvt. Ltd</h1>
    ...
    <p className={classes.experience} style={{fontSize:"1.2rem",color:"#01bf71"}}>Worked on Islamic Book Android App as Android <span style={{color:"#fff"}}>Java</span> Developer.</p>
    <li className={classes.experience} style={{fontSize:"1.2rem",color:"#01bf71"}}>Fazail-E-Amaal Islamic Book Application.</li>
    <li className={classes.experience} style={{fontSize:"1.2rem",color:"#01bf71"}}>Technologies : Java, Android Studio, Android developer tools, XML, and SQLite Database.</li>
    <a className={classes.experience} style={{fontSize:"1.2rem",color:"#fff",}} href="https://play.google.com/store/apps/details?id=com.fazail.amaal.fazailsadqat.fazailedarood.fazailquran.fazailhaj.fazailamaal&hl=en_US&gl=US" >Fazal-E-Amaal</a>
